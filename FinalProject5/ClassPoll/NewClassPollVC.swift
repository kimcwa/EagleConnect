...
class NewClassPollVC: UIViewController {
    ...
    let courseArray = ["Select Course", "Calculus II", "Calculus II (Math/Science Majors)","Computer Science I", "Computer Science II", "Computer Organization with Lab", "Fundamentals of Political Science","General Chemistry", "Globalization", "Global Implications of Climate Change", "Introductory Physics", "Introduction to Abstract Math", "Linear Algebra", "Logic and Computation", "Multivariable Calculus", "Philosphy of the Person", "Swift", "Waves and Vibrations",]
